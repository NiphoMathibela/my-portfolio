    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/nipho/" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/NiphoMathibela" aria-label="GitHub" data-social="github">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a href="https://www.instagram.com/nipho.mathibela/" aria-label="Instagram" data-social="instagram">
            <div className="filled" />
