  ...
  return (
    <div className="m-auto w-8/12 mt-16">
        ...
        <div className="flex flex-wrap justify-center">
            ...
            <div className= "bg-yellow w-20 h-20 text-black rounded-lg m-2 grow md:w-40 md:h-40">
            ...
            <div className= "bg-gray w-20 h-20 text-black rounded-lg m-2 grow md:w-40 md:h-40">
                <p className= "text-center font-bold text-2xl align-middle mt-6 md:text-4xl md:mt-14">SQL</p>
            </div>

            <div className= "bg-green w-20 h-20 text-black rounded-lg m-2 grow md:w-40 md:h-40">
